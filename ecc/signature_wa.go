...
import (
	...
	"github.com/dwjpeng/roxe_go/btcsuite/btcd/btcec"
	"github.com/dwjpeng/roxe_go/btcsuite/btcutil/base58"
)
...
func (s *innerWASignature) publicKey(content []byte, hash []byte) (out PublicKey, err error) {
	...
	// which contains more than just the X and Y points in the WA case on ROXE. Indeed, the
