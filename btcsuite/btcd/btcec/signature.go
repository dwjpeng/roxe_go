...
func SignCompact(curve *KoblitzCurve, key *PrivateKey, hash []byte, isCompressedKey bool) ([]byte, error) {
	...
	// See: https://github.com/ROXE/roxe/blob/master/libraries/fc/src/crypto/elliptic_impl_priv.cpp#L96
	// See: https://github.com/ROXE/roxejs-ecc/blob/master/src/signature.js#L178
