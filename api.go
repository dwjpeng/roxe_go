	...
	api := &API{
		HttpClient: &http.Client{
			Transport: &http.Transport{
				...
				DisableKeepAlives:     true, // default behavior, because of `nodroxe`'s lack of support for Keep alives.
			},
		},
...
// main `nodroxe` software doesn't in the version from March 22nd
...
// ProducerResume will resume block production on a nodroxe with
