...
func TestUnmarshalAccountResp(t *testing.T) {
	...
	assert.Equal(t, AccountName("roxeriobrazil"), resp.AccountName)
}

func TestUnmarshalBlockResp(t *testing.T) {
	RegisterAction(AccountName("roxedactokens"), ActionName("transfer"), Transfer{})
	...
	assert.Equal(t, AccountName("bitfinexroxe1"), resp.Producer)
	...
	assert.Equal(t, AccountName("roxedactokens"), action.Account)
...
var accountResponseJSONData = fmt.Sprintf(`{
	...
	"total_resources": {
		"owner": "roxeriobrazil",
		"net_weight": "32.4628 ROXE",
		"cpu_weight": "32.9628 ROXE",
		"ram_bytes": 145360
	},
	...
	"refund_request": {
		...
		"net_amount": "2.9284 ROXE",
		"cpu_amount": "2.9284 ROXE"
	},
	"voter_info": {
		"owner": "roxeriobrazil",
		"proxy": "",
