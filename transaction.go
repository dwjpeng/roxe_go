...
const (
	ROXE_ProtocolFeatureActivation BlockHeaderExtensionType = iota
	ROXE_ProducerScheduleChangeExtension
)
...
var blockHeaderExtensions = map[string]blockHeaderExtensionMap{
	"ROXE": {
		ROXE_ProtocolFeatureActivation:       func() BlockHeaderExtension { return new(ProtocolFeatureActivationExtension) },
		ROXE_ProducerScheduleChangeExtension: func() BlockHeaderExtension { return new(ProducerScheduleChangeExtension) },
	},
}
...
func (e *ProtocolFeatureActivationExtension) TypeID() BlockHeaderExtensionType {
	return ROXE_ProtocolFeatureActivation
}
...
func (e *ProducerScheduleChangeExtension) TypeID() BlockHeaderExtensionType {
	return ROXE_ProducerScheduleChangeExtension
}
...
type TransactionTrace struct {
	...
	ProducerBlockID Checksum256               `json:"producer_block_id" roxe:"optional"`
	Receipt         *TransactionReceiptHeader `json:"receipt,omitempty" roxe:"optional"`
	...
	} `json:"account_ram_delta" roxe:"optional"`
	FailedDtrxTrace *TransactionTrace `json:"failed_dtrx_trace,omitempty" roxe:"optional"`
	Except          *Except           `json:"except,omitempty" roxe:"optional"`
	ErrorCode       *Uint64           `json:"error_code,omitempty" roxe:"optional"`
}
