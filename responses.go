...
type ActionTrace struct {
	...
	Receipt                                *ActionTraceReceipt `json:"receipt,omitempty" roxe:"optional"`
	Receiver                               AccountName         `json:"receiver"`
	...
	// Not present in ROXE >= 1.8.x
	InlineTraces []ActionTrace `json:"inline_traces,omitempty" roxe:"-"`
}
...
type CurrencyBalanceResp struct {
	ROXEBalance       Asset    `json:"roxe_balance"`
