...
func TestABI_DecodeAction(t *testing.T) {
	...
	assert.Equal(t, "roxecanadacom", gjson.GetBytes(json, "struct_1_field_1").String())
...
func TestABI_decode_Float32FitNodroxe(t *testing.T) {
...
func TestABI_decode_StructFieldTypeHasArrayOfAliasArray(t *testing.T) {
	...
	assert.JSONEq(t, `{"player_hands_string":[["Diamond 3|d64e128fd187cc04a9495e0e3e5c20c982c0571fb96928a7803c916a9022113f,06fcee20464e7a8ac3210d041e3568cd4e40947d7f741c7c242cca1425f562e1,ROXE7GaQBbgYwi1Migb7xkAv88SpvzvsScx2Bvom8J26Y2sUmFpp3Z,SIG_K1_K6f7kx2uccZuBYPsMLVJZqxmFecLBvyiVgx83mdHVq9FysrfBcLf8gJbp7RTx3MEWrFrJTpacgb7k7KhNRdMs8osN5rQos","Diamond A|2dd24da7d81c96d5338262384943d3f501ac2881f7c637ebaedf32e29e394e51,06fcee220c57d55b568de137b887e8e9d0421e3140001b10d4f9e2f8190de002,ROXE7GaQBbgYwi1Migb7xkAv88SpvzvsScx2Bvom8J26Y2sUmFpp3Z,SIG_K1_K2bm66gmco5SQknGcdbLMMx8FM34iX2wNuCgNDC7rT28p1z3geHmpWP7q9uG3jrpo8jhqGM3YipWabGr7XA1qj9JTZJ7oG","Heart 3|750cf1fa96c7ded0dc1c6756bab26a5ed1f052b70b706c279ff068ef90a63163,06fcee3fb68f4808fb141449e5688fc80a878ef2c1f06701d7383b655fe4c6f6,ROXE7GaQBbgYwi1Migb7xkAv88SpvzvsScx2Bvom8J26Y2sUmFpp3Z,SIG_K1_JvHJXwf3afFR6Jhy7ZAZWtKWnsmZNjWSUncTR8jin8UzbLHjGYvLqM871fcpV2js8iSsVX2MjnM7BnYL7Sg9wzRoHtmqo5","Spade 4|a7fa6755e6f2775465342f53c739371688428c31a0f0fff4aef17d41cbb2a7f4,06fcee6a5c3f48569008d8387fff58632bad9c4f95e827e13285ecc8b3376f34,ROXE7GaQBbgYwi1Migb7xkAv88SpvzvsScx2Bvom8J26Y2sUmFpp3Z,SIG_K1_KZdN3pUX25WBT8xyWN4xU965nYLrsLHWa3Q891HaiHExtKrSYK1b667vy7mRc1fVQHGDqv2h1bH173dkvDjuR6N6P73UFD"]]}`, string(json))
}
...
func TestABI_decodeFields(t *testing.T) {
	...
	assert.JSONEq(t, `{"F1":"18446744073709551615", "F2":"roxecanadacom"}`, toJSON(t, json))
}
...
func TestABI_decodeOptionalField(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:         "optional not present fit nodroxe",
			fitNodroxe:   true,
			data:         optionalNotPresent,
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			abi.fitNodroxe = test.fitNodroxe
...
func TestABI_Read(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "int128 fit nodroxe", fitNodroxe: true, typeName: "int128", data: Int128{Lo: 925, Hi: 125}, expectedValue: s(`"2305843009213693952925"`)},
		{name: "int128 negative fit nodroxe ", fitNodroxe: true, typeName: "int128", data: Int128{Lo: 1, Hi: math.MaxUint64}, expectedValue: s(`"-18446744073709551615"`)},
		...
		{name: "uint128 fit nodroxe", fitNodroxe: true, typeName: "uint128", data: Uint128{Lo: 925, Hi: 125}, expectedValue: s(`"2305843009213693952925"`)},
		...
		{name: "uint128 fit nodroxe", fitNodroxe: true, typeName: "uint128", data: Uint128{Lo: math.MaxUint64, Hi: math.MaxUint64}, expectedValue: s(`"340282366920938463463374607431768211455"`)},
		...
		{name: "Name", typeName: "name", data: Name("roxecanadacom"), expectedValue: s(`"roxecanadacom"`)},
		...
		{name: "symbol", typeName: "symbol", data: ROXESymbol, expectedValue: s(`"4,ROXE"`)},
		{name: "symbol_code", typeName: "symbol_code", data: SymbolCode(22606239386324546), expectedValue: s(`"BNTDAPP"`)},
		{name: "asset", typeName: "asset", data: Asset{Amount: 100000, Symbol: ROXESymbol}, expectedValue: s(`"10.0000 ROXE"`)},
		{name: "extended_asset", typeName: "extended_asset", data: ExtendedAsset{Asset: Asset{Amount: 10, Symbol: ROXESymbol}, Contract: "roxecanadacom"}, expectedValue: s("{\"quantity\":\"0.0010 ROXE\",\"contract\":\"roxecanadacom\"}")},
		{name: "bad type", typeName: "bad.type.1", data: nil, expectedValue: nil, expectError: true},
		{name: "min float64 fit nodroxe", fitNodroxe: true, typeName: "float64", data: math.SmallestNonzeroFloat64, expectedValue: s(`"0.00000000000000000"`)},
		{name: "max float64 fit nodroxe", fitNodroxe: true, typeName: "float64", data: math.MaxFloat64, expectedValue: s(`".00000000000000000"`)},
		{name: "bool true fit nodroxe", fitNodroxe: true, typeName: "bool", data: true, expectedValue: s("1")},
		{name: "bool false  fit nodroxe", fitNodroxe: true, typeName: "bool", data: false, expectedValue: s("0")},
	}
...
func TestABI_Read_Symbol(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, `"4,ROXE"`, toJSON(t, out))
}
...
func Test_formatTimePoint(t *testing.T) {
	tests := []struct {
		name             string
		time             TimePoint
		shouldFitNodroxe bool
		expectedOutput   string
	}{
		{
			name:             "golden path with fit nodroxe",
			time:             1588450213523000,
			shouldFitNodroxe: false,
			expectedOutput:   "2020-05-02T20:10:13.523",
		},
		{
			name:             "golden path without fit nodroxe",
			time:             1588450213523000,
			shouldFitNodroxe: false,
			expectedOutput:   "2020-05-02T20:10:13.523",
		},
		{
			name:             "0 nano second with fit nodroxe",
			time:             1568822400000000,
			shouldFitNodroxe: true,
			expectedOutput:   "2019-09-18T16:00:00.000",
		},
		{
			name:             "0 nano second without fit nodroxe",
			time:             1568822400000000,
			shouldFitNodroxe: false,
			expectedOutput:   "2019-09-18T16:00:00",
		},
		{
			name:             "500 nano second with fit nodroxe",
			time:             1588450213500000,
			shouldFitNodroxe: true,
			expectedOutput:   "2020-05-02T20:10:13.500",
		},
		{
			name:             "500 nano second without fit nodroxe",
			time:             1588450213500000,
			shouldFitNodroxe: false,
			expectedOutput:   "2020-05-02T20:10:13.5",
		},
		{
			name:             "520 nano second with fit nodroxe",
			time:             1588450213520000,
			shouldFitNodroxe: true,
			expectedOutput:   "2020-05-02T20:10:13.520",
		},
		{
			name:             "520 nano second without fit nodroxe",
			time:             1588450213520000,
			shouldFitNodroxe: false,
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			time := formatTimePoint(test.time, test.shouldFitNodroxe)
			//fmt.Println(time)
