...
type BlockchainParameters struct {
	MaxBlockNetUsage               roxe.Uint64 `json:"max_block_net_usage"`
...
type ROXEGlobalState struct {
	BlockchainParameters
	TotalStorageBytesReserved roxe.Uint64 `json:"total_storage_bytes_reserved"`
	TotalStorageStake         roxe.Uint64 `json:"total_storage_stake"`
	PaymentPerBlock           roxe.Uint64 `json:"payment_per_block"`
}

// Nonce represents the `roxe.system::nonce` action. It is used to
